...
<div class="app">
    ...
    <aside class="side">
        ...
        <div class="nav">
            <a class="{{ request()->routeIs('admin.parks') ? 'active' : '' }}"
               href="{{ route('admin.parks') }}">
                🏢 Parks / Clients
            </a>

            <a class="{{ request()->routeIs('admin.parks.create') ? 'active' : '' }}"
               href="{{ route('admin.parks.create') }}">
                ➕ Add Park
            </a>

            <a class="{{ request()->routeIs('admin.tickets') || request()->routeIs('admin.tickets.show') ? 'active' : '' }}"
               href="{{ route('admin.tickets') }}">
                🎫 Complaint Tickets
            </a>

            <a class="{{ request()->routeIs('admin.tickets.create') ? 'active' : '' }}"
               href="{{ route('admin.tickets.create') }}">
                ➕ Create Ticket
            </a>

            <a class="{{ request()->routeIs('admin.spare-parts') || request()->routeIs('admin.spare-parts.edit') ? 'active' : '' }}"
               href="{{ route('admin.spare-parts') }}">
                📦 Spare Parts
            </a>

            <a class="{{ request()->routeIs('admin.spare-parts.create') ? 'active' : '' }}"
...
<div class="nav">
    ...
    <a href="{{ route('admin.inventory-items') }}"
       class="{{ request()->routeIs('admin.inventory-items') || request()->routeIs('admin.inventory-items.edit') ? 'active' : '' }}">
        📦 Inventory Items
    </a>

    <a href="{{ route('admin.inventory-items.create') }}"
       class="{{ request()->routeIs('admin.inventory-items.create') ? 'active' : '' }}">
        ➕ Add Inventory Item
    </a>

    <a href="{{ route('admin.spare-parts') }}"
...
<a href="{{ route('admin.inventory-movements') }}"
   class="{{ request()->routeIs('admin.inventory-movements') ? 'active' : '' }}">
    📊 Stock Movements
</a>

<a href="{{ route('admin.inventory.stock-in') }}"
   class="{{ request()->routeIs('admin.inventory.stock-in') ? 'active' : '' }}">
    📥 Stock In
</a>

<a href="{{ route('admin.inventory.stock-out') }}"
   class="{{ request()->routeIs('admin.inventory.stock-out') ? 'active' : '' }}">
    📤 Stock Out
</a>
        ...
        <div class="top">
            ...
            <div class="user">
                ...
                <div>
                    ...
                    <small class="muted">{{ Auth::user()->role == 'admin' ? 'Administrator' : ucfirst(Auth::user()->role) }}</small>
                </div>
