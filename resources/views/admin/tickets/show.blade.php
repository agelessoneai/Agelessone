...
<div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <a href="{{ route('admin.tickets') }}" class="btn-blue">← Back to Tickets</a>
            </div>
            ...
            <div class="card-dark">
                <div class="grid">
                    <div>
                        ...
                        <div class="value">{{ $ticket->park->name }}</div><br>

                        <div class="label">Ride / Item</div>
                        <div class="value">{{ $ticket->item_name }}</div><br>

                        <div class="label">Complaint</div>
                        <div class="value">{{ $ticket->complaint_title }}</div><br>

                        <div class="label">Description</div>
                        <div class="desc">{{ $ticket->complaint_description ?? '-' }}</div>
                    </div>

                    <div>
                        <div class="label">Assigned Engineer</div>
                        <div class="value">{{ $ticket->staff->name ?? '-' }}</div><br>

                        <div class="label">Priority</div>
                        <div class="value">{{ ucfirst($ticket->priority) }}</div><br>

                        <div class="label">Status</div>
                        <div class="status">{{ strtoupper(str_replace('_',' ',$ticket->status)) }}</div><br><br>
...
<div class="card-dark">
    ...
    <div class="row mt-4">
        ...
        <div class="col-md-6 mb-4">
            ...
            <div class="value">{{ $ticket->staff->name ?? '-' }}</div>
        </div>
        ...
        <div class="col-md-6 mb-4">
            ...
            @elseif($ticket->travel_status == 'arrived')
        ...
        <div class="col-md-6 mb-4">
            ...
            <div class="value">
                {{ $ticket->live_location_updated_at
        ...
        <div class="col-md-6 mb-4">
            ...
            <div class="value">{{ $ticket->park->name }}</div>
        </div>
...
<div class="card-dark">
    ...
    <div class="timeline mt-4">
        @forelse($ticket->updates as $update)
            <div class="update">
                <strong>{{ ucfirst(str_replace('_',' ',$update->update_type)) }}</strong><br>
                ...
                @if($update->spare_parts)
                    <div style="color:#f2b53b;font-weight:800;margin-top:10px;">
                        Required Spare Parts: {{ $update->spare_parts }}
                    </div>
                @endif

                @if($update->image)
                    <br>
                    <img class="photo" src="{{ asset('storage/'.$update->image) }}">
                @endif
            </div>
        @empty
...
function loadEngineerLocation(){
    fetch("{{ route('admin.tickets.liveLocation', $ticket->id) }}")
