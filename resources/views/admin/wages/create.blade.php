...
@section('page-title', 'Add Wage Entry — ' . $workSite->name)
...
<div class="wage-form-card">
    ...
    <p class="sub">{{ $workSite->name }} — Enter worker hours and wage rates for auto-calculation.</p>

    <form method="POST" action="{{ route('admin.work-sites.wages.store', $workSite) }}" id="wageForm">
        @csrf
        ...
        <div class="d-flex justify-content-between mt-4">
            <a href="{{ route('admin.work-sites.wages.index', $workSite) }}" class="btn btn-outline-secondary">Cancel</a>
