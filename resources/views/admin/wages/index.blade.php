...
@section('page-title', 'Worker Wages — ' . $workSite->name)
...
<div class="wage-card">
    <div class="wage-header">
        <div>
            <h4>💰 Worker Wages</h4>
            <p>{{ $workSite->name }} — Wage records and overtime calculations</p>
        </div>
        <a href="{{ route('admin.work-sites.wages.create', $workSite) }}" class="btn btn-primary d-flex align-items-center gap-2">
...
<a href="{{ route('admin.work-sites.show', $workSite) }}" class="btn btn-outline-secondary mt-3">← Back to Work Site</a>
@endsection
