...
@section('page-title', 'Edit Wage Entry')
...
<div class="wage-form-card">
    ...
    <form method="POST" action="{{ route('admin.wages.update', $wage) }}">
        @csrf
        @method('PUT')
        ...
        <div class="d-flex justify-content-between mt-4">
            ...
            <button type="submit" class="btn btn-primary px-5">Update Wage Entry</button>
        </div>
    </form>
</div>
