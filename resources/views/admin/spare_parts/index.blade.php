        ...
        <div class="content">
            <div class="card-dark">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    ...
                    <a href="{{ route('admin.spare-parts.create') }}" class="btn-blue">+ Add Spare Part</a>
                </div>
                      ...
                      <tbody>
                            @foreach($parts as $part)
                                <tr>
                                    ...
                                    <td>{{ $part->stock }} PCS</td>


                                    <td>₹{{ number_format($part->unit_price,2) }}</td>

                                    <td>
                                        @if($part->stock <= $part->minimum_stock)
                                    ...
                                    <td>
                                        <div style="display:flex;gap:10px;align-items:center;">
                                            ...
                                            <form method="POST"
                                                action="{{ route('admin.spare-parts.destroy', $part->id) }}"
