...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Ageless One'); ?></title>
...
<?php if(auth()->guard()->check()): ?><a class="profile-fab" href="<?php echo e(route('profile.edit')); ?>" aria-label="My Profile">👤</a><?php endif; ?>
...
<?php /**PATH C:\xampp\htdocs\ageless-admin-panel\resources\views/layouts/mobile.blade.php ENDPATH**/ ?>