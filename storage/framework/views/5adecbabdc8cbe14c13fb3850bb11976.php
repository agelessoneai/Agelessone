<?php $__env->startSection('page-title', 'Machine QR Code'); ?>
    ...
    <div class="col-md-6">
        <div class="card text-center" id="printable-area">
            ...
            <div class="card-body p-5 d-flex flex-column align-items-center">
                <div class="mb-3">
                    <h3 class="text-white"><?php echo e($machine->name); ?></h3>
                </div>
                ...
                <div class="text-muted small mb-4 word-break" style="max-width: 100%; word-break: break-all;">
                    ...
                    ?>
                    <a href="<?php echo e($dynamicUrl); ?>" target="_blank" class="text-info"><?php echo e($dynamicUrl); ?></a>
                    <?php if(str_contains($dynamicUrl, '127.0.0.1') || str_contains($dynamicUrl, 'localhost')): ?>
                ...
                <div class="no-print d-flex gap-3">
                    ...
                    <a href="<?php echo e(route('admin.machines.index')); ?>" class="btn btn-outline-light">
                        Back to List
                    </a>
                </div>
            </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        new QRCode(document.getElementById("qrcode"), {
            text: "<?php echo e(route('machines.show', $machine->id)); ?>",
            text: "<?php echo e($dynamicUrl); ?>",
            width: 200,
            height: 200,
            colorDark : "#000000",
            colorLight : "#ffffff",
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Agelessone\resources\views/admin/machines/qr.blade.php ENDPATH**/ ?>