<?php $__env->startSection('page-title', 'Add Wage Entry — ' . $workSite->name); ?>
...
<div class="wage-form-card">
    ...
    <p class="sub"><?php echo e($workSite->name); ?> — Enter worker hours and wage rates for auto-calculation.</p>

    <form method="POST" action="<?php echo e(route('admin.work-sites.wages.store', $workSite)); ?>" id="wageForm">
        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="d-flex justify-content-between mt-4">
            <a href="<?php echo e(route('admin.work-sites.wages.index', $workSite)); ?>" class="btn btn-outline-secondary">Cancel</a>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Agelessone\resources\views/admin/wages/create.blade.php ENDPATH**/ ?>