<?php $__env->startSection('page-title', 'Worker Wages Management'); ?>
...
<div class="wage-card">
    ...
    <form method="GET" class="wage-filters mb-4">
        <div>
            ...
            <select name="work_site_id" onchange="this.form.submit()">
                ...
                <?php $__currentLoopData = $workSites; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $site): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($site->id); ?>" <?php echo e(request('work_site_id') == $site->id ? 'selected' : ''); ?>><?php echo e($site->site_name); ?></option>
        ...
        <?php if(request()->anyFilled(['work_site_id', 'worker_id', 'month'])): ?>
            <div>
                <label class="d-block mb-1">&nbsp;</label>
                <a href="<?php echo e(route('admin.wages.index')); ?>" class="btn btn-sm btn-outline-secondary">Reset Filters</a>
            </div>
        <?php endif; ?>
    </form>
            ...
            <tbody>
                <?php $__empty_1 = true; $__currentLoopData = $wages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $wage): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr>
                        ...
                        <td><span class="badge-site"><?php echo e($wage->workSite->site_name ?? 'N/A'); ?></span></td>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Agelessone\resources\views/admin/wages/global-index.blade.php ENDPATH**/ ?>