...
<?php else: ?>
<small class="d-block mt-2 muted"><?php echo e($expense->reviewer?->name); ?> · <?php echo e(optional($expense->reviewed_at)->format('d M Y h:i A')); ?></small>
<?php if($expense->review_note): ?><small><?php echo e($expense->review_note); ?></small><?php endif; ?>
<?php endif; ?>
</td></tr>
...
<<<<<<<< HEAD:storage/framework/views/1e2409cba5be05214d1992be70f8cd6b.php
...
========
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Agelessone\resources\views\expenses\index.blade.php ENDPATH**/ ?>
>>>>>>>> 2ed5218 (added added accept/reject,photo punching and user phno login):storage/framework/views/ebe8b3ea9ad25538b2975cb4cd42acc8.php
