...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Ageless One Sales'); ?></title>
...
<div class="admin-shell">
    <aside class="sidebar">
        ...
        <nav class="side-nav">
            <a class="<?php echo e(request()->routeIs('sales.dashboard') ? 'active' : ''); ?>" href="<?php echo e(route('sales.dashboard')); ?>">📈 Sales Dashboard</a>
            <a class="<?php echo e(request()->routeIs('sales.leads.index') || request()->routeIs('sales.leads.show') || request()->routeIs('sales.leads.edit') ? 'active' : ''); ?>" href="<?php echo e(route('sales.leads.index')); ?>">📋 Enquiries & Leads</a>
            <a class="<?php echo e(request()->routeIs('sales.leads.create') ? 'active' : ''); ?>" href="<?php echo e(route('sales.leads.create')); ?>">➕ Add Enquiry</a>
    ...
    <main class="main-area">
        <header class="topbar">
            <div class="topbar-title"><?php echo $__env->yieldContent('page-title', 'Sales'); ?></div>
            <div class="topbar-user">
                <?php if(auth()->user()->photo): ?><img class="avatar" style="object-fit:cover" src="<?php echo e(asset('storage/'.auth()->user()->photo)); ?>" alt="Profile"><?php else: ?>@if(auth()->user()->photo)<img class="avatar" style="object-fit:cover" src="<?php echo e(asset('storage/'.auth()->user()->photo)); ?>" alt="Profile"><?php else: ?><div class="avatar"><?php echo e(strtoupper(substr(auth()->user()->name ?? 'S', 0, 1))); ?></div><?php endif; ?>@endif
                <div><strong><?php echo e(auth()->user()->name ?? 'Sales User'); ?></strong><br><small class="muted"><?php echo e(ucfirst(str_replace('_',' ',auth()->user()->role ?? 'sales'))); ?></small></div>
...
<?php /**PATH C:\xampp\htdocs\ageless-admin-panel\resources\views/layouts/sales.blade.php ENDPATH**/ ?>