...
<div class="page-head">
    ...
    <a href="<?php echo e(route('admin.inventory-items.create')); ?>" class="btn-blue">
        + Add Inventory Item
    </a>
</div>
...
<div class="summary-grid">
    ...
    <div class="summary-card">
        ...
        <strong><?php echo e($summary['total_items']); ?></strong>
        <small>Registered inventory items</small>
    </div>

    <div class="summary-card">
        <span>Total Stock</span>
        <strong><?php echo e($summary['total_stock']); ?></strong>
    ...
    <div class="summary-card danger">
        ...
        <strong><?php echo e($summary['out_of_stock']); ?></strong>
        <small>Items requiring purchase</small>
    </div>

    <div class="summary-card value-card">
        <span>Inventory Value</span>
        <strong>₹<?php echo e(number_format($summary['inventory_value'], 2)); ?></strong>
...
<div class="card-dark filter-card">
    ...
    <form method="GET" action="<?php echo e(route('admin.inventory-items')); ?>">
        ...
        <div class="filter-grid">
            ...
            <div class="filter-actions">
                ...
                <a href="<?php echo e(route('admin.inventory-items')); ?>" class="btn-secondary">
                    Reset
                </a>
            </div>
            ...
            <tbody>
                ...
                <?php $__empty_1 = true; $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    ...
                    <tr>
                        ...
                        <td>
                            <?php if($item->image): ?>
                                <a href="<?php echo e(asset('storage/'.$item->image)); ?>" target="_blank">
                                    <img
                                        src="<?php echo e(asset('storage/'.$item->image)); ?>"
                                        alt="<a href="<?php echo e(route('admin.inventory-items.show', $item)); ?>" style="color:inherit;text-decoration:none;font-weight:700"><?php echo e($item->item_name); ?></a>"
                                        class="item-photo"
                                    >
                                </a>
                            <?php else: ?>
                        ...
                        <td>
                            <strong><a href="<?php echo e(route('admin.inventory-items.show', $item)); ?>" style="color:inherit;text-decoration:none;font-weight:700"><?php echo e($item->item_name); ?></a></strong>
                            ...
                            <?php if($item->barcode): ?>
                                <div class="small-muted">
                                    Barcode: <?php echo e($item->barcode); ?>
                        ...
                        <td>
                            <strong>
                                <?php echo e($item->stock); ?> <?php echo e(strtoupper($item->unit)); ?>

                            </strong>

                            <div class="small-muted">
                                Min: <?php echo e($item->minimum_stock); ?>

                                · Max: <?php echo e($item->maximum_stock); ?>

                            </div>
                        </td>

                        <td>
                            ₹<?php echo e(number_format($item->stock * $item->purchase_price, 2)); ?>
                        ...
                        <td>
                            ...
                            <?php elseif($item->stock <= $item->minimum_stock): ?>
                        ...
                        <td>
                            <div class="action-group">
                                ...
                                <a
                                    href="<?php echo e(route('admin.inventory-items.edit', $item->id)); ?>"
                                ...
                                <form
                                    method="POST"
                                    action="<?php echo e(route('admin.inventory-items.destroy', $item->id)); ?>"
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\ageless-admin-panel\resources\views\admin\inventory_items\index.blade.php ENDPATH**/ ?>