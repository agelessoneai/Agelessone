        ...
        <header class="topbar">
            ...
            <div class="topbar-user">
                <?php if(auth()->user()->photo): ?>
                    <img class="avatar" style="object-fit:cover" src="<?php echo e(asset('storage/'.auth()->user()->photo)); ?>" alt="Profile">
                <?php else: ?>
...
</html><?php /**PATH C:\xampp\htdocs\Agelessone\resources\views/layouts/sales.blade.php ENDPATH**/ ?>