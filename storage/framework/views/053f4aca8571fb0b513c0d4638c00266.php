...
<div class="page-head">
            ...
            <div class="module-grid">
                ...
                <a href="<?php echo e(route('admin.wages.index')); ?>" class="module-card">
                    ...
                    <div>
                        <h3>Worker Wages</h3>
                        <p>Track worker wages, overtime, and daily standard hours.</p>
                    </div>
                </a>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Agelessone\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>