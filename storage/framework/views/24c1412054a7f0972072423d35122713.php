...
<div class="card-dark">
    ...
    <form
        method="POST"
        action="<?php echo e(route('admin.inventory-items.store')); ?>"
        ...
        <div class="form-grid">
            ...
            <div class="field">
                ...
                <input
                    ...
                    name="warehouse"
                    class="form-control"
                    value="<?php echo e(old('warehouse', 'Main Warehouse')); ?>"
                    required
                >
            </div>
            ...
            <div class="field">
                ...
                <input
                    ...
                    name="maximum_stock"
                    class="form-control"
                    value="<?php echo e(old('maximum_stock', 100)); ?>"
                    min="0"
                    required
                >
            </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\ageless-admin-panel\resources\views\admin\inventory_items\create.blade.php ENDPATH**/ ?>